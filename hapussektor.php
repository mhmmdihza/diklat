...
$make_call = callAPI('POST', 'http://localhost:8080/sektor/delete/'.$_SESSION['username'], json_encode($data_array));
$response = json_decode($make_call, true);




    echo "<script>alert('Data berhasil dihapus!'); window.location='kelolasektor.php';</script>";
