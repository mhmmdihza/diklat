...
$data_array =  array('id' => $_POST["nama"], 'jenis' => $_POST["id_sub_kategori"]);
$make_call = callAPI('POST', 'http://localhost:8080/nondetailBarang/save/'.$_SESSION['username'], json_encode($data_array));
