...
if(isset($_GET['id'])||!empty($_GET['id'])){
    ...
    $make_callGetData = callAPI('POST', 'http://localhost:8080/sektor/find', json_encode($data_arrayEdit ));
...
<div class="row">
  ...
  <div id ="demo" class="col-6 col-s-9">
	<br />
	<h3>Kelola Sektor</h3>
	<form action="sektoradd.php" method="post">
		<?php 
		  if($isEdit){
		...
		<table>
			<tr>
				<td>Nama Sektor</td>
				<td><input type="text" name="namasektor" required <?php if($isEdit){
				    echo 'readonly="readonly" style="background: #dddddd"; value="'.$dataEdit['namaSektor'].'"';
				}?>></td>					
			</tr>	
			<tr>
				<td>Deskripsi</td>
				<td><textarea type="text" name="deskripsi" rows="4" cols="50"><?php if($isEdit){
				    echo $dataEdit['deskripsi'];
				}?></textarea></td>					
			</tr>					
			</tr>
				<td></td>
