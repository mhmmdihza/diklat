...
if(isset($_GET['id'])||!empty($_GET['id'])){
    ...
    $make_callGetData = callAPI('POST', 'http://localhost:8080/s', json_encode($data_arrayEdit ));
...
<div class="row">
  ...
  <div id ="demo" class="col-6 col-s-9">
	<h4>Kelola Kategori Perlengkapan Non Operasional</h4>
	<form action="nonkategoriadd.php" method="post">
		<?php 
		  if($isEdit){
