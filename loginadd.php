...
$make_call = callAPI('POST', 'http://localhost:8080/login/save/'.$_SESSION['username'], json_encode($data_array));
$response = json_decode($make_call, true);

if($response){
    echo "<script>alert('Data berhasil ditambahkan!'); window.location='/kelolalogin.php';</script>";
}else{
