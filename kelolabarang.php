...
<div class="row">
  ...
  <div id ="demo" class="col-6 col-s-9">
	<h1> Kriteria Barang </h1>
	<br />
	<div class="table-responsive">
  
  	<ul class="w3-ul w3-card-4">
      <li><a href="/kategoriperlengkapanoperasional.php?id=1">Perlengkapan Operasional</a></li>
      <li><a href="/kategoriperlengkapannonoperasional.php?id=2">Perlengkapan Non Operasional</a></li>
    </ul>
	</div>
